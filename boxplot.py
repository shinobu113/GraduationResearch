...
bpes = [axes[i].boxplot([label0[:,int(i/3),(i%3)], label1[:,int(i/3),(i%3)]], patch_artist=True, labels=['label:0', 'label1'], widths=0.3, medianprops=dict(color='black', linewidth=1)) for i in range(6)]
